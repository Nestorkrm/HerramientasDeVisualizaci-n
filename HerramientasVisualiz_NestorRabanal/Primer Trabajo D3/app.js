...
margins = { top: 50, left: 80, right: 15, bottom: 160 }
...
function render(data) {
  ...
  yAxisCall = d3.axisLeft(y)
                .ticks(3)
                .tickFormat(d => d + ((metrica == 'Harvested_area') ? 'Ha.' : ''))
